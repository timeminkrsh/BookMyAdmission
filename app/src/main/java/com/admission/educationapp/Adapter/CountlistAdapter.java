...
public class CountlistAdapter extends RecyclerView.Adapter<CountlistAdapter.ViewHolder> {
    public Context context;
    public List<CountlistModel> papularModelList;
    String student_name,Quota;
    private ProgressDialog progressDialog;
    public CountlistAdapter(Context context, List<CountlistModel> countlist) {
    ...
    @NonNull
    @Override
    public CountlistAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CountlistAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.box.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (status == 1) {
                    ...
                    popupMenu.getMenu().add(Menu.NONE, Menu.NONE, 0, "Name = "+papularModelList.get(position).getStudent_name());
                    popupMenu.getMenu().add(Menu.NONE,Menu.NONE,0,"ID = "+papularModelList.get(position).getId());
                    popupMenu.show();
                }
